...
def curate_community_course(
    ...
    *,
    ...
    prompt = (
        ...
        "실제 존재하는 장소만, 후기에서 자주 묶이는 동선을 반영하라. 첫날은 도착이라 숙소 근처에서 "
        "가볍게, 마지막 날은 출국이라 공항 근처에서 가볍게(먼 일정·당일치기 금지).\n"
...
def arrange_itinerary(
    ...
    *,
    ...
    prompt = (
        ...
        "남기지 마라(시내 날은 4~5곳을 유지). 첫날은 도착이라 숙소 근처에서 가볍게 시작하고, "
        "마지막 날(출국일)은 짐을 찾아 공항으로 가야 하니 본거지·공항 근처에서 가벼운 2~3곳만 "
        "두고 먼 근교·당일치기·동반 도시는 절대 마지막 날에 넣지 마라(비행기를 놓친다).\n"
