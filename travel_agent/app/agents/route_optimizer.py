...
# 주의: 짧고 흔한 토큰은 넣지 마라 — 부분일치라 '바'는 '바트요/바르셀로나', 'bar'는
# 'Barri/Barcelona/harbor'까지 야경으로 오분류해 일반 관광지의 22시 캡을 새게 한다.
# 루프톱 바는 '루프톱/rooftop'으로 이미 잡힌다.
_NIGHT_VIEW_KEYWORDS = (
    "야경", "전망", "전망대", "전망실", "전망타워", "나이트", "night",
